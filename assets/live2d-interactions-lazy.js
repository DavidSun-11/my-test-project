...
(function () {
    ...
    function ensureOpeningBubbleStyles() {
        ...
        style.textContent = [
            ...
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"]{position:relative;display:flex!important;flex-direction:column!important;gap:16px!important;width:100%!important;box-sizing:border-box;padding:24px!important;border:1px solid rgba(178,237,255,.72);border-radius:26px;background:radial-gradient(circle at 50% -12%,rgba(126,218,255,.28),transparent 34%),radial-gradient(circle at 92% 18%,rgba(178,124,255,.2),transparent 32%),linear-gradient(150deg,rgba(6,22,48,.82),rgba(18,52,91,.64) 52%,rgba(25,35,78,.68));box-shadow:0 24px 58px rgba(0,10,34,.36),0 0 34px rgba(91,204,255,.26),inset 0 1px 0 rgba(255,255,255,.24),inset 0 -26px 54px rgba(74,84,184,.16);overflow:hidden;color:rgba(238,250,255,.96);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"]::before{content:\"\";position:absolute;left:32px;right:32px;top:0;height:2px;background:linear-gradient(90deg,transparent,rgba(225,252,255,.92),rgba(167,217,255,.82),transparent);box-shadow:0 0 16px rgba(117,218,255,.58);pointer-events:none;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"]::after{content:\"\";position:absolute;right:-34px;top:120px;width:150px;height:150px;border-radius:50%;background:radial-gradient(circle,rgba(121,211,255,.14),transparent 62%);pointer-events:none;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__header{display:grid!important;grid-template-columns:1fr auto!important;gap:10px 16px!important;align-items:start!important;padding:0 0 2px!important;border:0!important;background:transparent!important;box-shadow:none!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__heading{display:grid!important;gap:8px!important;min-width:0;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__eyebrow{display:inline-flex;width:max-content;align-items:center;gap:6px;padding:5px 11px;border:1px solid rgba(179,235,255,.62);border-radius:999px;background:linear-gradient(90deg,rgba(85,202,255,.2),rgba(190,143,255,.14));color:rgba(209,244,255,.98);font-size:12px;font-weight:850;box-shadow:0 0 16px rgba(99,211,255,.18);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title-row{display:flex;align-items:center;flex-wrap:wrap;gap:12px;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title{margin:0;font-size:32px;font-weight:940;line-height:1.05;letter-spacing:.01em;color:rgba(246,253,255,.99);text-shadow:0 0 18px rgba(112,217,255,.34),0 2px 0 rgba(12,34,62,.22);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__status-pill{align-self:start;white-space:nowrap;padding:8px 14px;border-radius:999px;border:1px solid rgba(194,241,255,.72);background:linear-gradient(90deg,rgba(79,191,255,.28),rgba(184,139,255,.22));box-shadow:0 0 18px rgba(100,211,255,.2),inset 0 1px 0 rgba(255,255,255,.22);color:rgba(241,253,255,.98);font-size:13px;font-weight:880;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__question{color:rgba(242,252,255,.98);font-size:17px;font-weight:850;line-height:1.38;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__desc{max-width:620px;color:rgba(201,229,247,.82);font-size:13px;line-height:1.65;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:12px!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-item{position:relative;display:grid!important;grid-template-columns:42px 1fr;align-items:center;gap:11px;min-width:0;padding:13px 14px!important;border:1px solid rgba(155,222,255,.45);border-radius:16px;background:linear-gradient(145deg,rgba(255,255,255,.1),rgba(84,162,224,.1));box-shadow:inset 0 1px 0 rgba(255,255,255,.18),0 10px 22px rgba(0,13,39,.16);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-icon{display:grid;place-items:center;width:42px;height:42px;border-radius:999px;border:1px solid rgba(194,242,255,.66);background:radial-gradient(circle at 35% 24%,rgba(255,255,255,.9),rgba(91,203,255,.72) 38%,rgba(58,96,222,.72));box-shadow:0 0 20px rgba(104,211,255,.35),inset 0 1px 0 rgba(255,255,255,.38);color:#fff;font-size:18px;font-weight:900;text-shadow:0 1px 6px rgba(0,18,42,.42);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-label{display:block;margin:0 0 4px;color:rgba(181,224,244,.82);font-size:12px;font-weight:720;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-value{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:rgba(246,253,255,.99);font-size:16px;font-weight:900;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__options{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:13px!important;width:100%!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option{position:relative;display:grid!important;grid-template-columns:58px 1fr auto;align-items:center;gap:14px;width:100%!important;min-height:92px!important;padding:16px!important;border:1px solid var(--score-border,rgba(169,230,255,.52))!important;border-radius:18px!important;background:radial-gradient(circle at 92% 18%,var(--score-soft,rgba(255,255,255,.13)),transparent 36%),linear-gradient(145deg,rgba(255,255,255,.1),rgba(52,113,178,.14))!important;box-shadow:0 13px 24px rgba(0,11,38,.2),0 0 20px var(--score-glow,rgba(110,210,255,.16)),inset 0 1px 0 rgba(255,255,255,.2)!important;color:rgba(242,252,255,.98)!important;text-align:left!important;box-sizing:border-box!important;opacity:1!important;filter:none!important;overflow:hidden;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option::before,.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option::after{content:none!important;display:none!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option:hover:not(:disabled){transform:translateY(-1px);border-color:rgba(232,253,255,.94)!important;box-shadow:0 0 28px var(--score-glow,rgba(110,210,255,.3)),inset 0 1px 0 rgba(255,255,255,.3)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option:disabled{opacity:1!important;cursor:default!important;color:inherit!important;filter:none!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--selected{border-color:rgba(234,253,255,.98)!important;background:radial-gradient(circle at 88% 18%,var(--score-soft,rgba(255,255,255,.2)),transparent 38%),linear-gradient(145deg,rgba(74,151,204,.88),rgba(94,72,160,.78))!important;box-shadow:0 0 30px var(--score-glow,rgba(112,221,255,.4)),inset 0 0 18px rgba(255,255,255,.16)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--wide{grid-column:1/-1!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__badge{display:grid;place-items:center;width:58px;height:58px;border-radius:18px;border:1px solid rgba(232,251,255,.64);background:var(--score-badge,linear-gradient(135deg,#dff8ff,#83d8ff));box-shadow:0 0 22px var(--score-glow,rgba(121,219,255,.3)),inset 0 1px 0 rgba(255,255,255,.44),inset 0 -10px 18px rgba(0,23,52,.16);color:#fff;font-size:19px;font-weight:950;text-shadow:0 1px 6px rgba(0,20,45,.45);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__body{display:grid;gap:7px;min-width:0;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__name{display:block;color:rgba(248,253,255,.99);font-size:20px;font-weight:920;line-height:1.08;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__count{display:block;color:rgba(208,233,248,.92);font-size:13px;font-weight:720;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__mark{align-self:start;justify-self:end;min-width:max-content;padding:5px 9px;border-radius:999px;border:1px solid rgba(190,244,255,.68);background:rgba(125,229,255,.2);color:rgba(238,253,255,.99);font-size:11px;font-weight:880;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__mark[aria-hidden=\"true\"]{visibility:hidden;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--bronze{--score-badge:linear-gradient(135deg,#ffe1b0,#d58b48 54%,#8f4d2e);--score-border:rgba(255,170,107,.7);--score-glow:rgba(231,137,65,.36);--score-soft:rgba(231,137,65,.2);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--silver{--score-badge:linear-gradient(135deg,#ffffff,#c9e7f8 50%,#7fa8c4);--score-border:rgba(207,237,255,.72);--score-glow:rgba(207,237,255,.36);--score-soft:rgba(207,237,255,.18);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--gold{--score-badge:linear-gradient(135deg,#fff8b2,#f0bf3d 52%,#b66f20);--score-border:rgba(255,218,92,.72);--score-glow:rgba(255,204,66,.36);--score-soft:rgba(255,204,66,.18);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--top{--score-badge:radial-gradient(circle at 35% 25%,#fff,#c79aff 45%,#5ddcff 78%);--score-border:rgba(186,139,255,.72);--score-glow:rgba(177,116,255,.4);--score-soft:rgba(177,116,255,.22);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--none{--score-badge:linear-gradient(135deg,#d8e6f5,#8099bd 52%,#506686);--score-border:rgba(151,178,214,.66);--score-glow:rgba(132,161,204,.26);--score-soft:rgba(132,161,204,.16);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__actions{display:flex!important;flex-wrap:wrap!important;align-items:center!important;justify-content:flex-start!important;gap:11px!important;width:100%!important;padding:13px!important;border:1px solid rgba(154,217,255,.38)!important;border-radius:18px!important;background:linear-gradient(145deg,rgba(255,255,255,.08),rgba(88,162,224,.11))!important;box-sizing:border-box!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action{display:inline-flex;align-items:center;justify-content:center;min-width:136px;min-height:44px;padding:10px 16px;border-radius:999px;border:1px solid rgba(175,230,255,.62);background:rgba(32,65,104,.58);box-shadow:inset 0 1px 0 rgba(255,255,255,.18);color:rgba(240,252,255,.98);font-size:14px;font-weight:850;line-height:1.2;cursor:pointer;white-space:nowrap;transition:transform .16s ease,border-color .16s ease,box-shadow .16s ease;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action:hover{transform:translateY(-1px);border-color:rgba(224,250,255,.88);box-shadow:0 0 18px rgba(101,211,255,.22),inset 0 1px 0 rgba(255,255,255,.24);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action--primary{border-color:rgba(191,243,255,.86);background:linear-gradient(135deg,rgba(76,202,255,.86),rgba(160,112,255,.76));box-shadow:0 0 20px rgba(98,210,255,.3),inset 0 1px 0 rgba(255,255,255,.26);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action--danger{border-color:rgba(255,198,216,.86);background:linear-gradient(135deg,rgba(245,105,156,.72),rgba(132,94,220,.72));}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action--soft{opacity:.9;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__footer-note{padding:11px 13px!important;border:1px solid rgba(169,226,255,.36)!important;border-radius:15px!important;background:rgba(11,31,59,.4)!important;color:rgba(220,240,255,.9)!important;font-size:13px!important;line-height:1.55!important;}",
            "@media (max-width:768px){.live2d-quiz.is-score-guess{width:min(92vw,calc(100vw - 24px));max-height:calc(100vh - 72px);padding:14px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"]{gap:13px!important;padding:15px!important;border-radius:22px;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__header,.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta,.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__options{grid-template-columns:1fr!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__status-pill{justify-self:start;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title{font-size:25px;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option{grid-template-columns:48px 1fr auto;min-height:82px!important;padding:13px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__badge{width:48px;height:48px;border-radius:16px;font-size:17px;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__name{font-size:18px;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__actions{display:grid!important;grid-template-columns:1fr!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action{width:100%;min-width:0;}}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"]{gap:18px!important;max-width:min(760px,calc(100vw - 32px))!important;margin:0 auto!important;padding:30px 30px 24px!important;border-radius:28px!important;border:1px solid rgba(165,232,255,.78)!important;background:radial-gradient(circle at 50% -8%,rgba(148,228,255,.38),transparent 32%),radial-gradient(circle at 98% 10%,rgba(188,126,255,.2),transparent 28%),radial-gradient(circle at 8% 92%,rgba(88,201,255,.16),transparent 32%),linear-gradient(155deg,rgba(5,20,47,.9),rgba(16,48,86,.76) 52%,rgba(18,30,70,.82))!important;box-shadow:0 0 0 1px rgba(229,252,255,.18),0 28px 70px rgba(0,12,38,.48),0 0 42px rgba(90,205,255,.34),inset 0 1px 0 rgba(255,255,255,.3),inset 0 -34px 68px rgba(88,92,190,.18)!important;-webkit-backdrop-filter:blur(20px);backdrop-filter:blur(20px);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"]::before{left:28px!important;right:28px!important;height:3px!important;background:linear-gradient(90deg,transparent,rgba(244,254,255,.98),rgba(132,221,255,.86),transparent)!important;box-shadow:0 0 24px rgba(124,225,255,.7)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"]::after{right:-48px!important;top:70px!important;width:190px!important;height:190px!important;background:radial-gradient(circle,rgba(108,214,255,.18),rgba(176,130,255,.08) 42%,transparent 68%)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__header{position:relative!important;display:flex!important;flex-direction:column!important;gap:10px!important;align-items:center!important;text-align:center!important;padding:2px 42px 4px!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__heading{display:flex!important;flex-direction:column!important;align-items:center!important;gap:10px!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__eyebrow{padding:6px 14px!important;background:linear-gradient(90deg,rgba(86,205,255,.24),rgba(198,151,255,.16))!important;border-color:rgba(196,242,255,.72)!important;box-shadow:0 0 18px rgba(98,211,255,.22),inset 0 1px 0 rgba(255,255,255,.24)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title-row{justify-content:center!important;gap:14px!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title{font-size:42px!important;font-weight:950!important;letter-spacing:.04em!important;text-shadow:0 0 22px rgba(118,221,255,.52),0 2px 0 rgba(8,22,48,.34)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__status-pill{padding:8px 18px!important;border-color:rgba(203,243,255,.86)!important;background:linear-gradient(90deg,rgba(82,190,255,.38),rgba(181,132,255,.26))!important;box-shadow:0 0 22px rgba(102,211,255,.3),inset 0 1px 0 rgba(255,255,255,.28)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__question{font-size:19px!important;font-weight:900!important;color:rgba(246,253,255,.99)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__desc{max-width:680px!important;margin:0 auto!important;color:rgba(203,229,247,.86)!important;font-size:14px!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta{grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:14px!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-item{grid-template-columns:46px 1fr!important;gap:12px!important;min-height:74px!important;padding:14px 16px!important;border-radius:17px!important;border-color:rgba(154,225,255,.58)!important;background:radial-gradient(circle at 18% 18%,rgba(113,220,255,.2),transparent 36%),linear-gradient(145deg,rgba(255,255,255,.12),rgba(71,146,210,.12))!important;box-shadow:0 12px 28px rgba(0,13,42,.2),inset 0 1px 0 rgba(255,255,255,.22)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-icon{width:46px!important;height:46px!important;background:radial-gradient(circle at 35% 25%,#fff,rgba(105,215,255,.82) 42%,rgba(61,96,225,.8))!important;box-shadow:0 0 24px rgba(104,211,255,.44),inset 0 1px 0 rgba(255,255,255,.46)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-label{font-size:12px!important;color:rgba(183,224,244,.86)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-value{font-size:17px!important;color:rgba(249,254,255,.99)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__options{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:14px!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option{grid-template-columns:64px 1fr auto!important;gap:15px!important;min-height:98px!important;padding:17px!important;border-radius:20px!important;background:radial-gradient(circle at 96% 12%,var(--score-soft),transparent 34%),radial-gradient(circle at 82% 78%,rgba(255,255,255,.08),transparent 36%),linear-gradient(145deg,rgba(255,255,255,.1),rgba(30,70,126,.26))!important;border-color:var(--score-border)!important;box-shadow:0 15px 32px rgba(0,10,38,.26),0 0 24px var(--score-glow),inset 0 1px 0 rgba(255,255,255,.22),inset 0 -18px 32px rgba(0,20,60,.12)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option:hover:not(:disabled){transform:translateY(-2px);box-shadow:0 18px 36px rgba(0,10,38,.28),0 0 34px var(--score-glow),inset 0 1px 0 rgba(255,255,255,.3)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option:disabled{opacity:1!important;cursor:default!important;color:inherit!important;filter:none!important;-webkit-text-fill-color:currentColor!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--selected{border-color:rgba(243,254,255,.98)!important;box-shadow:0 0 38px var(--score-glow),0 18px 36px rgba(0,10,38,.28),inset 0 0 22px rgba(255,255,255,.18)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__badge{width:64px!important;height:64px!important;border-radius:20px!important;font-size:22px!important;border-color:rgba(240,253,255,.74)!important;box-shadow:0 0 28px var(--score-glow),inset 0 1px 0 rgba(255,255,255,.5),inset 0 -12px 20px rgba(0,19,48,.18)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__name{font-size:22px!important;font-weight:950!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__count{font-size:14px!important;color:rgba(214,236,250,.94)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__mark{padding:6px 10px!important;background:rgba(134,232,255,.24)!important;border-color:rgba(206,248,255,.82)!important;box-shadow:0 0 14px rgba(119,225,255,.18)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--bronze{--score-badge:linear-gradient(135deg,#ffe5be,#d88947 52%,#7d3d28);--score-border:rgba(255,170,106,.82);--score-glow:rgba(232,136,64,.42);--score-soft:rgba(232,136,64,.24);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--silver{--score-badge:linear-gradient(135deg,#fff,#d8efff 48%,#7ba5c4);--score-border:rgba(216,241,255,.86);--score-glow:rgba(207,237,255,.44);--score-soft:rgba(207,237,255,.22);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--gold{--score-badge:linear-gradient(135deg,#fff9bd,#f3c23f 52%,#a7651d);--score-border:rgba(255,222,92,.86);--score-glow:rgba(255,205,66,.44);--score-soft:rgba(255,205,66,.22);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--top{--score-badge:radial-gradient(circle at 35% 24%,#fff,#ca9cff 44%,#58ddff 78%);--score-border:rgba(196,146,255,.86);--score-glow:rgba(179,116,255,.48);--score-soft:rgba(179,116,255,.28);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--none{--score-badge:linear-gradient(135deg,#dce9f7,#829bbe 52%,#4e637f);--score-border:rgba(153,184,222,.76);--score-glow:rgba(132,161,204,.32);--score-soft:rgba(132,161,204,.2);}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--wide{grid-column:1/-1!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__actions{justify-content:center!important;gap:14px!important;padding:16px!important;border-radius:20px!important;background:linear-gradient(145deg,rgba(255,255,255,.09),rgba(80,158,221,.13))!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action{min-height:48px!important;min-width:154px!important;padding:12px 18px!important;border-radius:999px!important;font-size:15px!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action--primary{background:linear-gradient(135deg,rgba(87,213,255,.92),rgba(168,118,255,.82))!important;box-shadow:0 0 26px rgba(102,213,255,.38),inset 0 1px 0 rgba(255,255,255,.32)!important;}",
            ".score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__footer-note{text-align:center!important;color:rgba(195,227,247,.9)!important;background:linear-gradient(90deg,transparent,rgba(98,183,240,.12),transparent)!important;border-color:rgba(169,226,255,.28)!important;}",
            "@media (max-width:768px){.live2d-quiz.is-score-guess{width:min(92vw,calc(100vw - 24px))!important;max-height:calc(100vh - 88px)!important;padding:12px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"]{max-width:92vw!important;gap:13px!important;padding:16px!important;border-radius:22px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__header{padding:0 34px 2px!important;align-items:flex-start!important;text-align:left!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__heading{align-items:flex-start!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title-row{justify-content:flex-start!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title{font-size:27px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__question{font-size:16px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta,.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__options{grid-template-columns:1fr!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-item{min-height:62px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option{grid-template-columns:50px 1fr auto!important;min-height:86px!important;padding:13px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__badge{width:50px!important;height:50px!important;border-radius:16px!important;font-size:17px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__name{font-size:18px!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__actions{display:grid!important;grid-template-columns:1fr!important;}.score-guess-panel[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action{width:100%!important;min-width:0!important;}}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"]{display:flex!important;flex-direction:column!important;gap:18px!important;width:min(760px,calc(100vw - 32px))!important;max-width:100%!important;max-height:calc(100vh - 96px)!important;overflow-y:auto!important;overflow-x:hidden!important;padding:30px 30px 24px!important;border-radius:30px!important;border:1px solid rgba(177,236,255,.82)!important;background:radial-gradient(circle at 50% -10%,rgba(158,231,255,.4),transparent 33%),radial-gradient(circle at 96% 10%,rgba(191,134,255,.22),transparent 30%),linear-gradient(155deg,rgba(5,20,47,.92),rgba(16,47,86,.78) 54%,rgba(18,31,70,.84))!important;box-shadow:0 0 0 1px rgba(230,252,255,.18),0 30px 74px rgba(0,12,38,.5),0 0 48px rgba(91,207,255,.36),inset 0 1px 0 rgba(255,255,255,.32),inset 0 -34px 68px rgba(88,92,190,.18)!important;-webkit-backdrop-filter:blur(20px) saturate(1.16);backdrop-filter:blur(20px) saturate(1.16);}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__header{display:flex!important;flex-direction:column!important;align-items:center!important;text-align:center!important;gap:10px!important;padding:2px 42px 4px!important;border:0!important;background:transparent!important;box-shadow:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__heading{display:contents!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__eyebrow{display:inline-flex!important;width:max-content!important;align-items:center!important;gap:8px!important;padding:6px 15px!important;border-radius:999px!important;border:1px solid rgba(197,243,255,.75)!important;background:linear-gradient(90deg,rgba(86,205,255,.24),rgba(198,151,255,.16))!important;box-shadow:0 0 18px rgba(98,211,255,.24),inset 0 1px 0 rgba(255,255,255,.24)!important;color:rgba(217,246,255,.98)!important;font-size:13px!important;font-weight:860!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__eyebrow::before{content:\"✦\";color:rgba(202,244,255,.98);text-shadow:0 0 10px rgba(120,224,255,.55);}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title-row{display:flex!important;align-items:center!important;justify-content:center!important;flex-wrap:wrap!important;gap:14px!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title{margin:0!important;font-size:42px!important;font-weight:950!important;letter-spacing:.04em!important;line-height:1.05!important;color:rgba(248,253,255,.99)!important;text-shadow:0 0 22px rgba(118,221,255,.52),0 2px 0 rgba(8,22,48,.34)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__status-pill{padding:8px 18px!important;border-radius:999px!important;border:1px solid rgba(203,243,255,.86)!important;background:linear-gradient(90deg,rgba(82,190,255,.38),rgba(181,132,255,.26))!important;box-shadow:0 0 22px rgba(102,211,255,.3),inset 0 1px 0 rgba(255,255,255,.28)!important;color:rgba(242,253,255,.99)!important;font-size:14px!important;font-weight:880!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__question{margin:0!important;color:rgba(246,253,255,.99)!important;font-size:19px!important;font-weight:900!important;line-height:1.4!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__desc{max-width:680px!important;margin:0 auto!important;color:rgba(203,229,247,.86)!important;font-size:14px!important;line-height:1.65!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:12px!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-item{display:grid!important;grid-template-columns:46px 1fr!important;grid-template-areas:\"icon label\" \"icon value\"!important;align-items:center!important;gap:4px 12px!important;min-width:0!important;min-height:74px!important;padding:14px 16px!important;border-radius:17px!important;border:1px solid rgba(154,225,255,.58)!important;background:radial-gradient(circle at 18% 18%,rgba(113,220,255,.2),transparent 36%),linear-gradient(145deg,rgba(255,255,255,.12),rgba(71,146,210,.12))!important;box-shadow:0 12px 28px rgba(0,13,42,.2),inset 0 1px 0 rgba(255,255,255,.22)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-icon{grid-area:icon!important;display:grid!important;place-items:center!important;width:46px!important;height:46px!important;border-radius:999px!important;border:1px solid rgba(204,244,255,.7)!important;background:radial-gradient(circle at 35% 25%,#fff,rgba(105,215,255,.82) 42%,rgba(61,96,225,.8))!important;box-shadow:0 0 24px rgba(104,211,255,.44),inset 0 1px 0 rgba(255,255,255,.46)!important;color:#fff!important;font-size:18px!important;font-weight:900!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-label{grid-area:label!important;display:block!important;margin:0!important;color:rgba(183,224,244,.86)!important;font-size:12px!important;font-weight:760!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-value{grid-area:value!important;display:block!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;color:rgba(249,254,255,.99)!important;font-size:17px!important;font-weight:920!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__options{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:14px!important;width:100%!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option{position:relative!important;display:grid!important;grid-template-columns:64px 1fr auto!important;align-items:center!important;gap:15px!important;width:100%!important;min-height:98px!important;padding:17px!important;border-radius:20px!important;border:1px solid var(--score-border)!important;background:radial-gradient(circle at 96% 12%,var(--score-soft),transparent 34%),radial-gradient(circle at 82% 78%,rgba(255,255,255,.08),transparent 36%),linear-gradient(145deg,rgba(255,255,255,.1),rgba(30,70,126,.26))!important;box-shadow:0 15px 32px rgba(0,10,38,.26),0 0 24px var(--score-glow),inset 0 1px 0 rgba(255,255,255,.22),inset 0 -18px 32px rgba(0,20,60,.12)!important;color:rgba(242,252,255,.98)!important;text-align:left!important;box-sizing:border-box!important;opacity:1!important;filter:none!important;overflow:hidden!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option::before,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option::after{content:none!important;display:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option:disabled{opacity:1!important;cursor:default!important;color:inherit!important;filter:none!important;-webkit-text-fill-color:currentColor!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--wide{grid-column:1/-1!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__badge{display:grid!important;place-items:center!important;width:64px!important;height:64px!important;border-radius:20px!important;border:1px solid rgba(240,253,255,.74)!important;background:var(--score-badge)!important;box-shadow:0 0 28px var(--score-glow),inset 0 1px 0 rgba(255,255,255,.5),inset 0 -12px 20px rgba(0,19,48,.18)!important;color:#fff!important;font-size:22px!important;font-weight:950!important;text-shadow:0 1px 6px rgba(0,20,45,.45)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__name{display:block!important;color:rgba(248,253,255,.99)!important;font-size:22px!important;font-weight:950!important;line-height:1.08!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__count{display:block!important;margin-top:7px!important;color:rgba(214,236,250,.94)!important;font-size:14px!important;font-weight:740!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__mark{align-self:start!important;justify-self:end!important;min-width:max-content!important;padding:6px 10px!important;border-radius:999px!important;border:1px solid rgba(206,248,255,.82)!important;background:rgba(134,232,255,.24)!important;box-shadow:0 0 14px rgba(119,225,255,.18)!important;color:rgba(238,253,255,.99)!important;font-size:11px!important;font-weight:880!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__actions{display:flex!important;flex-wrap:wrap!important;align-items:center!important;justify-content:center!important;gap:12px!important;width:100%!important;padding:16px!important;border:1px solid rgba(154,217,255,.38)!important;border-radius:20px!important;background:linear-gradient(145deg,rgba(255,255,255,.09),rgba(80,158,221,.13))!important;box-sizing:border-box!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action{display:inline-flex!important;align-items:center!important;justify-content:center!important;min-width:154px!important;min-height:48px!important;padding:12px 18px!important;border-radius:999px!important;border:1px solid rgba(175,230,255,.62)!important;background:rgba(32,65,104,.58)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.18)!important;color:rgba(240,252,255,.98)!important;font-size:15px!important;font-weight:850!important;white-space:nowrap!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action--primary{border-color:rgba(191,243,255,.86)!important;background:linear-gradient(135deg,rgba(87,213,255,.92),rgba(168,118,255,.82))!important;box-shadow:0 0 26px rgba(102,213,255,.38),inset 0 1px 0 rgba(255,255,255,.32)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action--danger{border-color:rgba(255,198,216,.86)!important;background:linear-gradient(135deg,rgba(245,105,156,.72),rgba(132,94,220,.72))!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__footer-note{text-align:center!important;padding:11px 13px!important;border:1px solid rgba(169,226,255,.28)!important;border-radius:15px!important;background:linear-gradient(90deg,transparent,rgba(98,183,240,.12),transparent)!important;color:rgba(195,227,247,.9)!important;font-size:13px!important;line-height:1.55!important;}",
            "@media (max-width:720px){.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"]{width:min(92vw,520px)!important;padding:20px!important;gap:13px!important;border-radius:22px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__header{padding:0 34px 2px!important;align-items:flex-start!important;text-align:left!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__title{font-size:28px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__options{grid-template-columns:1fr!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option{grid-template-columns:50px 1fr auto!important;min-height:86px!important;padding:13px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__badge{width:50px!important;height:50px!important;border-radius:16px!important;font-size:17px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__actions{display:grid!important;grid-template-columns:1fr!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action{width:100%!important;min-width:0!important;}}",
    ...
    function ensureScoreGuessFinalStyles() {
        ...
        style.textContent = [
            ...
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:12px!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-item{display:grid!important;grid-template-columns:46px 1fr!important;grid-template-areas:\"icon label\" \"icon value\"!important;align-items:center!important;gap:4px 12px!important;min-width:0!important;min-height:74px!important;padding:14px 16px!important;border-radius:17px!important;border:1px solid rgba(154,225,255,.58)!important;background:radial-gradient(circle at 18% 18%,rgba(113,220,255,.2),transparent 36%),linear-gradient(145deg,rgba(255,255,255,.12),rgba(71,146,210,.12))!important;box-shadow:0 12px 28px rgba(0,13,42,.2),inset 0 1px 0 rgba(255,255,255,.22)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-icon{grid-area:icon!important;display:grid!important;place-items:center!important;width:46px!important;height:46px!important;border-radius:999px!important;border:1px solid rgba(204,244,255,.7)!important;background:radial-gradient(circle at 35% 25%,#fff,rgba(105,215,255,.82) 42%,rgba(61,96,225,.8))!important;box-shadow:0 0 24px rgba(104,211,255,.44),inset 0 1px 0 rgba(255,255,255,.46)!important;color:#fff!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-label{grid-area:label!important;display:block!important;margin:0!important;color:rgba(183,224,244,.86)!important;font-size:12px!important;font-weight:760!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta-value{grid-area:value!important;display:block!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;color:rgba(249,254,255,.99)!important;font-size:17px!important;font-weight:920!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__options{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:14px!important;width:100%!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option{appearance:none!important;-webkit-appearance:none!important;font:inherit!important;position:relative!important;display:grid!important;grid-template-columns:64px 1fr auto!important;align-items:center!important;gap:15px!important;width:100%!important;min-height:98px!important;padding:17px!important;border-radius:20px!important;border:1px solid var(--score-border)!important;background:radial-gradient(circle at 96% 12%,var(--score-soft),transparent 34%),radial-gradient(circle at 82% 78%,rgba(255,255,255,.08),transparent 36%),linear-gradient(145deg,rgba(255,255,255,.1),rgba(30,70,126,.26))!important;background-clip:padding-box!important;box-shadow:0 15px 32px rgba(0,10,38,.26),0 0 24px var(--score-glow),inset 0 1px 0 rgba(255,255,255,.22),inset 0 -18px 32px rgba(0,20,60,.12)!important;color:rgba(242,252,255,.98)!important;text-align:left!important;box-sizing:border-box!important;opacity:1!important;filter:none!important;overflow:hidden!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option:disabled{appearance:none!important;-webkit-appearance:none!important;opacity:1!important;cursor:default!important;color:inherit!important;filter:none!important;-webkit-text-fill-color:currentColor!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--wide{grid-column:1/-1!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--bronze{--score-badge:linear-gradient(135deg,#ffe5be,#d88947 52%,#7d3d28);--score-border:rgba(255,170,106,.82);--score-glow:rgba(232,136,64,.42);--score-soft:rgba(232,136,64,.24);}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--silver{--score-badge:linear-gradient(135deg,#fff,#d8efff 48%,#7ba5c4);--score-border:rgba(216,241,255,.86);--score-glow:rgba(207,237,255,.44);--score-soft:rgba(207,237,255,.22);}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--gold{--score-badge:linear-gradient(135deg,#fff9bd,#f3c23f 52%,#a7651d);--score-border:rgba(255,222,92,.86);--score-glow:rgba(255,205,66,.44);--score-soft:rgba(255,205,66,.22);}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--top{--score-badge:radial-gradient(circle at 35% 24%,#fff,#ca9cff 44%,#58ddff 78%);--score-border:rgba(196,146,255,.86);--score-glow:rgba(179,116,255,.48);--score-soft:rgba(179,116,255,.28);}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option--none{--score-badge:linear-gradient(135deg,#dce9f7,#829bbe 52%,#4e637f);--score-border:rgba(153,184,222,.76);--score-glow:rgba(132,161,204,.32);--score-soft:rgba(132,161,204,.2);}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-option__badge{display:grid!important;place-items:center!important;width:64px!important;height:64px!important;border-radius:20px!important;border:1px solid rgba(240,253,255,.74)!important;background:var(--score-badge)!important;box-shadow:0 0 28px var(--score-glow),inset 0 1px 0 rgba(255,255,255,.5),inset 0 -12px 20px rgba(0,19,48,.18)!important;color:#fff!important;font-size:22px!important;font-weight:950!important;text-shadow:0 1px 6px rgba(0,20,45,.45)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__actions{display:flex!important;flex-wrap:wrap!important;align-items:center!important;justify-content:center!important;gap:12px!important;width:100%!important;padding:16px!important;border:1px solid rgba(154,217,255,.38)!important;border-radius:20px!important;background:linear-gradient(145deg,rgba(255,255,255,.09),rgba(80,158,221,.13))!important;box-sizing:border-box!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action{appearance:none!important;-webkit-appearance:none!important;font:inherit!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;min-width:154px!important;min-height:48px!important;padding:12px 18px!important;border-radius:999px!important;border:1px solid rgba(175,230,255,.62)!important;background:rgba(32,65,104,.58)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.18)!important;color:rgba(240,252,255,.98)!important;font-size:15px!important;font-weight:850!important;white-space:nowrap!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action--primary{border-color:rgba(191,243,255,.86)!important;background:linear-gradient(135deg,rgba(87,213,255,.92),rgba(168,118,255,.82))!important;box-shadow:0 0 26px rgba(102,213,255,.38),inset 0 1px 0 rgba(255,255,255,.32)!important;}",
            "@media (max-width:720px){.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"]{width:min(92vw,520px)!important;padding:20px!important;gap:13px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__meta,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__options{grid-template-columns:1fr!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-panel__actions{display:grid!important;grid-template-columns:1fr!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260620-score-guess-final2\"] .score-guess-action{width:100%!important;min-width:0!important;}}"
        ].join("");
        document.head.appendChild(style);
    }
    ...
    function initInteractions() {
        ...
        function renderScoreGuessResults(state, message, type) {
            ...
            dialog.setAttribute("data-score-guess-ui-version", "20260620-score-guess-final2");
            options.setAttribute("data-score-guess-ui-version", "20260620-score-guess-final2");
            options.innerHTML = [
                '<div class="score-guess-panel score-guess-panel--final" data-score-guess-ui-version="20260620-score-guess-final2">',
            ...
            console.info("[score-guess-ui]", {
                version: "20260620-score-guess-final2",
                hasPanel: !!document.querySelector('[data-score-guess-ui-version="20260620-score-guess-final2"]'),
