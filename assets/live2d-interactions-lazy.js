...
(function () {
    ...
    function ensureOpeningBubbleStyles() {
        ...
        if (existingStyle) {
            if (existingStyle.textContent && existingStyle.textContent.indexOf("20260625-live2d-menu-nightlake1") !== -1) {
                return;
            }
        ...
        style.textContent = [
            "/* 20260625-live2d-menu-nightlake1 */",
            ...
            ".live2d-quiz.is-main-menu{position:relative!important;width:min(374px,calc(100vw - 34px))!important;max-width:calc(100vw - 34px)!important;padding:15px 16px 16px!important;border:1px solid rgba(174,226,246,.5)!important;border-radius:20px!important;overflow:hidden!important;background:radial-gradient(circle at 20% 8%,rgba(158,218,255,.14),transparent 34%),radial-gradient(circle at 86% 10%,rgba(188,170,255,.1),transparent 34%),linear-gradient(180deg,rgba(9,22,46,.86),rgba(8,25,51,.74) 54%,rgba(9,34,62,.82))!important;box-shadow:0 16px 38px rgba(2,11,28,.42),0 0 24px rgba(103,198,238,.16),inset 0 1px 0 rgba(255,255,255,.18),inset 0 -18px 30px rgba(83,161,210,.1)!important;-webkit-backdrop-filter:blur(16px) saturate(1.12);backdrop-filter:blur(16px) saturate(1.12);}",
            ".live2d-quiz.is-main-menu::before{content:\"\"!important;position:absolute;left:14px!important;right:46px!important;top:9px!important;height:1px!important;background:linear-gradient(90deg,transparent,rgba(221,247,255,.7),rgba(176,213,255,.3),transparent)!important;box-shadow:0 0 14px rgba(120,210,245,.22);animation:live2d-menu-starglint 12s ease-in-out infinite;pointer-events:none;}",
            ".live2d-quiz.is-main-menu::after{content:\"\";position:absolute;left:-18px;right:-18px;bottom:-4px;height:74px;background:linear-gradient(90deg,rgba(170,224,255,0),rgba(170,224,255,.16),rgba(170,224,255,0)) 0 18px/120px 1px repeat-x,linear-gradient(90deg,rgba(215,236,255,0),rgba(215,236,255,.1),rgba(215,236,255,0)) 36px 36px/150px 1px repeat-x,radial-gradient(ellipse at 50% 100%,rgba(91,183,236,.16),transparent 68%);opacity:.75;filter:blur(.1px);mask-image:linear-gradient(to top,rgba(0,0,0,.85),rgba(0,0,0,.2),transparent);-webkit-mask-image:linear-gradient(to top,rgba(0,0,0,.85),rgba(0,0,0,.2),transparent);animation:live2d-nightlake-ripple 18s linear infinite;pointer-events:none;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__meta{position:relative;z-index:1;margin-bottom:4px;color:rgba(210,238,250,.82);font-size:12px;letter-spacing:.02em;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__question{position:relative;z-index:1;margin:0 0 10px!important;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__options{position:relative;z-index:1;}",
            ".live2d-quiz.is-main-menu .live2d-menu-header{gap:6px;}",
            ".live2d-quiz.is-main-menu .live2d-menu-title{font-size:18px;font-weight:780;text-shadow:0 0 14px rgba(111,202,241,.26);}",
            ".live2d-quiz.is-main-menu .live2d-menu-user{padding:4px 9px;border-color:rgba(177,226,247,.38);background:linear-gradient(90deg,rgba(81,170,215,.12),rgba(170,156,255,.08));font-size:11px;color:rgba(210,236,248,.86);}",
            ".live2d-quiz.is-main-menu .live2d-quiz__menu{grid-template-columns:1fr 1fr!important;gap:8px!important;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__option{min-height:42px!important;padding:9px 12px 9px 35px!important;border:1px solid rgba(175,226,247,.42)!important;border-radius:999px!important;background:linear-gradient(145deg,rgba(22,59,97,.5),rgba(16,38,74,.44))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.14),inset 0 -8px 18px rgba(91,173,226,.07),0 6px 14px rgba(0,13,35,.16)!important;color:rgba(231,248,255,.94)!important;font-size:13px!important;font-weight:720!important;overflow:hidden;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__option::before{left:11px!important;width:16px!important;height:16px!important;background:radial-gradient(circle,rgba(235,252,255,.72),rgba(114,196,232,.18))!important;box-shadow:0 0 10px rgba(139,218,255,.22)!important;font-size:10px!important;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__option::after{content:\"\";position:absolute;inset:0;background:linear-gradient(105deg,transparent 18%,rgba(222,247,255,.22) 45%,transparent 68%);opacity:0;transform:translateX(-36%);transition:opacity .18s ease,transform .36s ease;pointer-events:none;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__option:hover:not(:disabled){transform:translateY(-1px);border-color:rgba(220,246,255,.72)!important;background:linear-gradient(145deg,rgba(32,74,112,.58),rgba(23,47,90,.52))!important;box-shadow:0 0 17px rgba(112,204,242,.18),inset 0 1px 0 rgba(255,255,255,.2)!important;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__option:hover:not(:disabled)::after{opacity:.7;transform:translateX(30%);}",
            ".live2d-quiz.is-main-menu .live2d-quiz__close{width:28px!important;height:28px!important;border-color:rgba(219,242,255,.64)!important;background:radial-gradient(circle at 35% 30%,rgba(255,255,255,.4),rgba(116,185,222,.34) 44%,rgba(10,30,58,.62))!important;box-shadow:0 0 14px rgba(145,213,244,.22),inset 0 1px 0 rgba(255,255,255,.22)!important;color:rgba(244,252,255,.96)!important;}",
            ...
            "@media (max-width:768px){.live2d-quiz.is-main-menu{width:min(330px,calc(100vw - 24px))!important;max-width:calc(100vw - 24px)!important;padding:14px!important;}.live2d-quiz.is-main-menu .live2d-quiz__menu{grid-template-columns:1fr!important;gap:8px!important;}.live2d-quiz.is-main-menu .live2d-quiz__option{width:100%;min-width:0;min-height:40px!important;}.live2d-quiz.is-main-menu::after{height:54px;opacity:.55;}}",
            "@media (prefers-reduced-motion:reduce){.live2d-quiz.is-main-menu::before,.live2d-quiz.is-main-menu::after,.live2d-quiz.is-main-menu .live2d-quiz__option::after{animation:none!important;transition:none!important;}.live2d-quiz.is-main-menu::after{opacity:.28;}.live2d-quiz.is-main-menu .live2d-quiz__option:hover:not(:disabled){transform:none;}}",
