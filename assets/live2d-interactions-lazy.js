...
(function () {
    ...
    function ensureOpeningBubbleStyles() {
        ...
        if (existingStyle) {
            if (existingStyle.textContent && existingStyle.textContent.indexOf("20260624-live2d-menu-beautiful-replica5") !== -1) {
                return;
            }
        ...
        style.textContent = [
            "/* 20260624-live2d-menu-beautiful-replica5 */",
            ...
            "@media (max-width:768px){.live2d-quiz.is-main-menu{width:min(92vw,420px)!important;max-width:calc(100vw - 24px)!important;max-height:calc(100vh - 88px)!important;padding:0!important;}.live2d-menu-panel{height:min(560px,calc(100vh - 88px));min-height:0;border-radius:28px;}.live2d-menu-panel::before{inset:9px;border-radius:22px;}.live2d-menu-panel__ornament{left:16%;right:16%;top:28px;}.live2d-menu-panel__moon{top:12px;width:38px;height:38px;}.live2d-menu-panel__moon::after{left:14px;top:5px;width:27px;height:27px;}.live2d-menu-beautiful-content,.live2d-menu-panel__content{padding:54px 26px 30px;}.live2d-quiz.is-main-menu .live2d-quiz__question{margin-bottom:13px!important;}.live2d-quiz.is-main-menu .live2d-menu-title{font-size:22px;}.live2d-quiz.is-main-menu .live2d-menu-user{font-size:11px;padding:5px 10px;}.live2d-quiz.is-main-menu .live2d-quiz__menu{grid-template-columns:1fr!important;gap:11px!important;width:100%;max-height:258px;}.live2d-quiz.is-main-menu .live2d-quiz__option{width:100%;min-width:0;min-height:46px!important;padding:9px 44px!important;font-size:13px!important;}.live2d-quiz.is-main-menu .live2d-quiz__option::before{left:14px!important;width:20px!important;height:20px!important;}.live2d-quiz.is-main-menu .live2d-quiz__close{right:18px!important;top:18px!important;width:30px!important;height:30px!important;}.live2d-quiz.is-main-menu::after{height:64px;opacity:.5;}}",
    ...
    function initInteractions() {
        ...
        async function ensureBossReviewsApi() {
            await loadExternalScript("assets/supabase-config.js?v=20260611-1").catch(function () {});
            await loadExternalScript("assets/price-reviews.js?v=20260624-live2d-menu-beautiful-replica5");
