...
(function () {
    ...
    function ensureOpeningBubbleStyles() {
        ...
        if (existingStyle) {
            if (existingStyle.textContent && existingStyle.textContent.indexOf("20260624-live2d-menu-beautiful-replica4") !== -1) {
                return;
            }
        ...
        style.textContent = [
            "/* 20260624-live2d-menu-beautiful-replica4 */",
            ...
            ".live2d-menu-panel{position:relative;width:100%;height:min(720px,calc(100vh - 36px));min-height:min(620px,calc(100vh - 36px));box-sizing:border-box;overflow:hidden;border:1px solid rgba(166,230,255,.76);border-radius:36px;background:radial-gradient(circle at 50% 3%,rgba(226,252,255,.18),transparent 17%),radial-gradient(circle at 16% 11%,rgba(91,210,255,.16),transparent 32%),radial-gradient(circle at 84% 16%,rgba(174,140,255,.14),transparent 34%),radial-gradient(ellipse at 50% 106%,rgba(76,198,255,.18),transparent 48%),linear-gradient(180deg,rgba(8,21,55,.9),rgba(5,15,42,.94) 56%,rgba(8,27,61,.9));box-shadow:0 0 42px rgba(88,202,255,.2),0 0 22px rgba(178,139,255,.1),inset 0 1px 0 rgba(255,255,255,.27),inset 0 0 0 1px rgba(255,255,255,.08),inset 0 -36px 68px rgba(73,170,231,.09);-webkit-backdrop-filter:blur(18px) saturate(1.16);backdrop-filter:blur(18px) saturate(1.16);}",
            ...
            ".live2d-menu-panel::after{content:\"\";position:absolute;left:10%;right:10%;bottom:10%;z-index:1;height:28%;border-radius:0 0 28px 28px;background:repeating-linear-gradient(0deg,rgba(182,237,255,0) 0,rgba(182,237,255,0) 12px,rgba(182,237,255,.07) 13px,rgba(182,237,255,0) 17px),radial-gradient(ellipse at 50% 100%,rgba(93,202,255,.15),transparent 72%);opacity:.54;filter:blur(.2px);mix-blend-mode:screen;animation:live2d-beautiful-ripple 22s linear infinite;pointer-events:none;}",
            ...
            ".live2d-menu-panel__moon::after{content:\"\";position:absolute;left:16px;top:5px;width:31px;height:31px;border-radius:50%;background:rgba(7,19,49,.9);box-shadow:-10px 0 15px rgba(7,19,49,.34);}",
            ".live2d-menu-beautiful-wave,.live2d-menu-panel__wave{position:absolute;left:10%;right:10%;bottom:9%;z-index:2;height:22%;border-radius:0 0 28px 28px;background:linear-gradient(90deg,rgba(170,224,255,0),rgba(170,224,255,.12),rgba(170,224,255,0)) 0 18px/140px 1px repeat-x,linear-gradient(90deg,rgba(215,236,255,0),rgba(215,236,255,.07),rgba(215,236,255,0)) 42px 38px/190px 1px repeat-x;opacity:.46;mix-blend-mode:screen;animation:live2d-beautiful-ripple 20s linear infinite;pointer-events:none;}",
            ".live2d-menu-beautiful-content,.live2d-menu-panel__content{position:relative;z-index:4;display:flex;flex-direction:column;align-items:center;height:100%;box-sizing:border-box;padding:72px 38px 58px;pointer-events:auto;}",
            ...
            ".live2d-quiz.is-main-menu .live2d-quiz__question{position:relative;z-index:2;width:100%;margin:0 0 20px!important;pointer-events:auto;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__options{position:relative;z-index:2;pointer-events:auto!important;}",
            ".live2d-quiz.is-main-menu .live2d-menu-header{display:grid;gap:8px;text-align:center;}",
    ...
    function initInteractions() {
        ...
        async function ensureBossReviewsApi() {
            await loadExternalScript("assets/supabase-config.js?v=20260611-1").catch(function () {});
            await loadExternalScript("assets/price-reviews.js?v=20260624-live2d-menu-beautiful-replica4");
