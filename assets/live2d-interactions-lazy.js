...
(function () {
    ...
    function ensureOpeningBubbleStyles() {
        ...
        style.textContent = [
            ...
            ".live2d-quiz.is-main-menu .live2d-quiz__question{position:relative;z-index:2;margin:0 0 10px!important;pointer-events:auto;}",
            ...
            ".live2d-quiz.is-main-menu .live2d-quiz__menu{position:relative;z-index:2;grid-template-columns:1fr 1fr!important;gap:8px!important;pointer-events:auto!important;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__option{position:relative!important;z-index:3;min-height:42px!important;padding:9px 12px 9px 35px!important;border:1px solid rgba(175,226,247,.42)!important;border-radius:999px!important;background:linear-gradient(145deg,rgba(22,59,97,.5),rgba(16,38,74,.44))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.14),inset 0 -8px 18px rgba(91,173,226,.07),0 6px 14px rgba(0,13,35,.16)!important;color:rgba(231,248,255,.94)!important;font-size:13px!important;font-weight:720!important;overflow:hidden;pointer-events:auto!important;touch-action:manipulation;}",
            ".live2d-quiz.is-main-menu .live2d-quiz__option::before{left:11px!important;width:16px!important;height:16px!important;background:radial-gradient(circle,rgba(235,252,255,.72),rgba(114,196,232,.18))!important;box-shadow:0 0 10px rgba(139,218,255,.22)!important;font-size:10px!important;pointer-events:none!important;}",
            ...
            ".live2d-quiz.is-main-menu .live2d-quiz__close{position:relative!important;z-index:4!important;width:28px!important;height:28px!important;border-color:rgba(219,242,255,.64)!important;background:radial-gradient(circle at 35% 30%,rgba(255,255,255,.4),rgba(116,185,222,.34) 44%,rgba(10,30,58,.62))!important;box-shadow:0 0 14px rgba(145,213,244,.22),inset 0 1px 0 rgba(255,255,255,.22)!important;color:rgba(244,252,255,.96)!important;pointer-events:auto!important;touch-action:manipulation;}",
