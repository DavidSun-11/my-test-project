...
(function () {
    const version = "20260702-score-guess-admin-visible1";
...
(function () {
    ...
    function ensureScoreGuessFinalStyles() {
        ...
        style.textContent = [
            ...
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"]{--pearl-ink:#5f3f91;--pearl-deep:#734aa3;--pearl-text:#6c4a93;--pearl-muted:rgba(103,78,136,.78);--pearl-line:rgba(255,255,255,.72);--pearl-lavender:rgba(229,211,255,.78);--pearl-blue:rgba(199,236,255,.78);--pearl-pink:rgba(255,218,243,.72);--pearl-gold:#b98037;--pearl-shadow:rgba(126,91,178,.24);position:relative!important;isolation:isolate!important;display:flex!important;flex-direction:column!important;gap:15px!important;width:100%!important;max-width:900px!important;max-height:calc(100vh - 94px)!important;overflow-y:auto!important;overflow-x:hidden!important;margin:0 auto!important;padding:28px 30px 24px!important;border:1px solid rgba(255,255,255,.72)!important;border-radius:30px!important;background:radial-gradient(circle at 18% 8%,rgba(255,255,255,.82),transparent 27%),radial-gradient(circle at 84% 10%,rgba(215,236,255,.74),transparent 30%),radial-gradient(circle at 50% 102%,rgba(255,237,202,.52),transparent 33%),linear-gradient(145deg,rgba(255,255,255,.76),rgba(239,226,255,.58) 42%,rgba(213,229,255,.54))!important;box-shadow:0 22px 58px rgba(90,64,142,.28),0 0 0 1px rgba(185,165,231,.22),0 0 36px rgba(229,211,255,.36),inset 0 1px 0 rgba(255,255,255,.9),inset 0 -30px 60px rgba(169,145,225,.12)!important;-webkit-backdrop-filter:blur(20px) saturate(1.22)!important;backdrop-filter:blur(20px) saturate(1.22)!important;box-sizing:border-box!important;color:var(--pearl-text)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"]::before{content:\"\"!important;position:absolute!important;inset:8px!important;z-index:0!important;border-radius:24px!important;border:1px solid rgba(177,146,222,.28)!important;background:linear-gradient(90deg,transparent,rgba(255,255,255,.9),transparent) top 18px left 50%/72% 1px no-repeat,linear-gradient(90deg,transparent,rgba(255,255,255,.62),transparent) bottom 18px left 50%/78% 1px no-repeat,radial-gradient(circle at 50% 0,rgba(255,255,255,.58),transparent 18%),radial-gradient(circle at 6% 8%,rgba(255,255,255,.36),transparent 16%),radial-gradient(circle at 94% 12%,rgba(208,226,255,.3),transparent 17%)!important;box-shadow:inset 0 0 0 1px rgba(255,255,255,.28),inset 0 0 34px rgba(255,255,255,.18)!important;pointer-events:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"]::after{content:\"\"!important;position:absolute!important;left:10%!important;right:10%!important;top:18px!important;height:150px!important;z-index:0!important;background:radial-gradient(circle at 20% 22%,rgba(255,255,255,.72) 0 2px,transparent 3px),radial-gradient(circle at 72% 18%,rgba(255,255,255,.58) 0 2px,transparent 3px),radial-gradient(circle at 52% 34%,rgba(205,181,244,.38) 0 3px,transparent 4px),linear-gradient(115deg,transparent 8%,rgba(255,255,255,.42) 18%,transparent 31%,rgba(209,226,255,.3) 42%,transparent 58%)!important;opacity:.9!important;-webkit-mask-image:linear-gradient(180deg,rgba(0,0,0,.86),transparent 86%);mask-image:linear-gradient(180deg,rgba(0,0,0,.86),transparent 86%);pointer-events:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"]>*{position:relative!important;z-index:1!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__header{display:flex!important;flex-direction:column!important;align-items:center!important;text-align:center!important;gap:8px!important;padding:2px 46px 4px!important;border:0!important;background:transparent!important;box-shadow:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__heading{display:flex!important;flex-direction:column!important;align-items:center!important;gap:8px!important;min-width:0!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__eyebrow{position:relative!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;min-height:34px!important;padding:6px 24px!important;border-radius:999px!important;border:1px solid rgba(181,147,225,.42)!important;background:linear-gradient(180deg,rgba(255,255,255,.88),rgba(247,236,255,.72))!important;box-shadow:0 8px 18px rgba(127,92,176,.16),inset 0 1px 0 rgba(255,255,255,.94),0 0 0 4px rgba(255,255,255,.16)!important;color:var(--pearl-deep)!important;font-size:13px!important;font-weight:900!important;letter-spacing:.04em!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__eyebrow::before,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__eyebrow::after{content:\"\"!important;position:absolute!important;top:50%!important;width:34px!important;height:1px!important;background:linear-gradient(90deg,transparent,rgba(179,142,222,.72))!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__eyebrow::before{right:100%!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__eyebrow::after{left:100%!important;transform:scaleX(-1)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__title-row{display:flex!important;align-items:center!important;justify-content:center!important;gap:12px!important;flex-wrap:wrap!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__title{margin:0!important;font-size:46px!important;font-weight:950!important;line-height:1.02!important;letter-spacing:0!important;color:#7650a6!important;text-shadow:0 1px 0 rgba(255,255,255,.9),0 5px 16px rgba(109,75,162,.2),0 0 22px rgba(255,255,255,.6)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__status-pill{display:inline-flex!important;align-items:center!important;justify-content:center!important;white-space:nowrap!important;padding:8px 15px!important;border-radius:999px!important;border:1px solid rgba(177,145,222,.44)!important;background:linear-gradient(180deg,rgba(255,255,255,.88),rgba(244,232,255,.72))!important;box-shadow:0 9px 18px rgba(121,86,176,.15),inset 0 1px 0 rgba(255,255,255,.94)!important;color:var(--pearl-deep)!important;font-size:13px!important;font-weight:900!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__question{color:var(--pearl-deep)!important;font-size:20px!important;font-weight:920!important;line-height:1.32!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__desc{max-width:680px!important;margin:0 auto!important;color:rgba(96,70,132,.82)!important;font-size:14px!important;line-height:1.62!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:13px!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta-item{position:relative!important;display:grid!important;grid-template-columns:54px minmax(0,1fr)!important;align-items:center!important;gap:12px!important;min-width:0!important;min-height:88px!important;padding:14px 16px!important;border-radius:20px!important;border:1px solid rgba(255,255,255,.74)!important;background:linear-gradient(145deg,rgba(255,255,255,.74),rgba(246,237,255,.54) 58%,rgba(224,236,255,.5))!important;box-shadow:0 12px 28px rgba(118,86,170,.14),inset 0 1px 0 rgba(255,255,255,.86),inset 0 -12px 26px rgba(191,169,231,.08)!important;overflow:hidden!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta-item::after{content:\"\"!important;position:absolute!important;inset:1px!important;border-radius:inherit!important;background:linear-gradient(120deg,rgba(255,255,255,.52),transparent 32%,transparent 72%,rgba(198,222,255,.28))!important;pointer-events:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta-icon{position:relative!important;z-index:1!important;display:grid!important;place-items:center!important;width:54px!important;height:54px!important;border-radius:999px!important;border:1px solid rgba(255,255,255,.82)!important;background:radial-gradient(circle at 35% 26%,#fff 0 18%,#f5eaff 34%,#c5dfff 58%,#9875d2 100%)!important;box-shadow:0 0 20px rgba(178,147,223,.28),0 8px 18px rgba(121,84,170,.12),inset 0 1px 0 rgba(255,255,255,.9)!important;color:#8059ad!important;font-size:19px!important;font-weight:950!important;text-shadow:0 1px 0 rgba(255,255,255,.8)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta-label{position:relative!important;z-index:1!important;display:block!important;margin:0 0 5px!important;color:var(--pearl-muted)!important;font-size:12px!important;font-weight:820!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta-value{position:relative!important;z-index:1!important;display:block!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;color:var(--pearl-deep)!important;font-size:18px!important;font-weight:950!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-settlement,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__voters{border:1px solid rgba(255,255,255,.66)!important;border-radius:20px!important;background:linear-gradient(145deg,rgba(255,255,255,.66),rgba(243,231,255,.46) 58%,rgba(221,236,255,.42))!important;box-shadow:0 12px 26px rgba(117,85,171,.12),inset 0 1px 0 rgba(255,255,255,.82)!important;color:var(--pearl-text)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(132px,180px)!important;gap:13px!important;align-items:end!important;padding:14px 16px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake__copy{display:grid!important;gap:5px!important;color:rgba(92,68,128,.78)!important;font-size:13px!important;line-height:1.46!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake__copy strong{color:var(--pearl-deep)!important;font-size:15px!important;font-weight:950!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake__field{display:grid!important;gap:6px!important;color:var(--pearl-muted)!important;font-size:12px!important;font-weight:850!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake__input{width:100%!important;min-height:42px!important;box-sizing:border-box!important;border:1px solid rgba(188,154,226,.4)!important;border-radius:14px!important;background:linear-gradient(180deg,rgba(255,255,255,.82),rgba(240,232,255,.66))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.92),0 0 16px rgba(199,177,236,.16)!important;color:var(--pearl-deep)!important;font:inherit!important;font-size:16px!important;font-weight:900!important;padding:9px 12px!important;outline:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake__input:focus{border-color:rgba(146,105,204,.72)!important;box-shadow:0 0 20px rgba(191,158,235,.32),inset 0 1px 0 rgba(255,255,255,.96)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-settlement{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:10px!important;padding:12px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-settlement__item{display:grid!important;gap:5px!important;min-width:0!important;padding:11px 12px!important;border-radius:15px!important;border:1px solid rgba(255,255,255,.58)!important;background:rgba(255,255,255,.48)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.7)!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-settlement__item span{color:var(--pearl-muted)!important;font-size:12px!important;font-weight:820!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-settlement__item strong{overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;color:var(--pearl-deep)!important;font-size:16px!important;font-weight:950!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__options{display:grid!important;grid-template-columns:repeat(5,minmax(118px,1fr))!important;gap:14px!important;width:100%!important;padding:6px 0 2px!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option{--score-card:rgba(246,235,255,.68);--score-border:rgba(196,164,224,.6);--score-glow:rgba(183,148,226,.24);--score-gem:radial-gradient(circle at 34% 24%,#fff,#d8c5ff 34%,#9e76d7 70%,#6f4eaa);position:relative!important;display:grid!important;grid-template-columns:1fr!important;grid-template-rows:auto auto 1fr!important;align-items:start!important;justify-items:center!important;gap:9px!important;width:100%!important;min-width:0!important;min-height:206px!important;padding:18px 12px 16px!important;border:1px solid var(--score-border)!important;border-radius:28px 28px 20px 20px!important;background:radial-gradient(circle at 50% 10%,rgba(255,255,255,.9),transparent 28%),radial-gradient(circle at 50% 70%,var(--score-card),transparent 54%),linear-gradient(180deg,rgba(255,255,255,.82),var(--score-card) 58%,rgba(255,255,255,.56))!important;box-shadow:0 18px 30px rgba(117,84,169,.18),0 0 24px var(--score-glow),inset 0 1px 0 rgba(255,255,255,.92),inset 0 -14px 26px rgba(136,98,190,.1)!important;color:var(--pearl-deep)!important;text-align:center!important;box-sizing:border-box!important;opacity:1!important;filter:none!important;overflow:hidden!important;cursor:pointer!important;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease,filter .18s ease!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option::before{content:\"\"!important;position:absolute!important;inset:8px!important;border-radius:22px 22px 16px 16px!important;border:1px solid rgba(255,255,255,.58)!important;background:linear-gradient(90deg,transparent,rgba(255,255,255,.72),transparent) top 12px center/76% 1px no-repeat,linear-gradient(120deg,rgba(255,255,255,.52),transparent 28%,transparent 72%,rgba(255,255,255,.34))!important;display:block!important;pointer-events:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option::after{content:\"\"!important;position:absolute!important;left:50%!important;bottom:8px!important;width:56px!important;height:8px!important;border-radius:999px!important;background:radial-gradient(ellipse,rgba(138,94,190,.2),transparent 72%)!important;transform:translateX(-50%)!important;display:block!important;pointer-events:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option:hover:not(:disabled){transform:translateY(-4px)!important;border-color:rgba(255,255,255,.95)!important;box-shadow:0 20px 34px rgba(117,84,169,.2),0 0 34px var(--score-glow),inset 0 1px 0 rgba(255,255,255,.95)!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option:disabled{opacity:1!important;filter:none!important;cursor:default!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option--wide{grid-column:auto!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__badge{position:relative!important;z-index:1!important;display:grid!important;place-items:center!important;width:82px!important;height:82px!important;margin-top:2px!important;border-radius:999px!important;border:1px solid rgba(255,255,255,.82)!important;background:var(--score-gem)!important;box-shadow:0 0 0 7px rgba(255,255,255,.22),0 0 24px var(--score-glow),0 10px 18px rgba(104,72,154,.14),inset 0 1px 0 rgba(255,255,255,.95),inset 0 -14px 20px rgba(94,60,142,.2)!important;color:#fff!important;font-size:26px!important;font-weight:950!important;text-shadow:0 1px 5px rgba(78,46,124,.35)!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__badge::after{content:\"\"!important;position:absolute!important;left:22%!important;top:16%!important;width:22%!important;height:22%!important;border-radius:50%!important;background:rgba(255,255,255,.82)!important;filter:blur(.2px)!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__body{position:relative!important;z-index:1!important;display:grid!important;gap:6px!important;min-width:0!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__name{display:block!important;color:var(--score-title,var(--pearl-deep))!important;font-size:26px!important;font-weight:950!important;line-height:1.08!important;text-shadow:0 1px 0 rgba(255,255,255,.86)!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__count{display:block!important;color:rgba(103,76,136,.82)!important;font-size:13px!important;font-weight:820!important;line-height:1.3!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__mark{position:absolute!important;left:50%!important;right:auto!important;top:auto!important;bottom:12px!important;z-index:2!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;min-width:70px!important;min-height:24px!important;margin:0!important;padding:4px 12px!important;border-radius:6px 6px 10px 10px!important;border:1px solid rgba(255,238,184,.78)!important;background:linear-gradient(180deg,#fff2c9,#c9893b)!important;box-shadow:0 0 18px rgba(221,158,69,.28),inset 0 1px 0 rgba(255,255,255,.7)!important;color:#fffdf7!important;font-size:12px!important;font-weight:950!important;text-shadow:0 1px 3px rgba(103,58,20,.42)!important;transform:translateX(-50%)!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__mark[aria-hidden=\"true\"]{display:none!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option--selected{transform:translateY(-3px)!important;border-color:rgba(255,235,178,.95)!important;box-shadow:0 20px 34px rgba(137,91,146,.22),0 0 34px var(--score-glow),0 0 26px rgba(224,164,69,.18),inset 0 1px 0 rgba(255,255,255,.96),inset 0 0 0 2px rgba(255,236,184,.42)!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option--bronze{--score-card:rgba(255,218,205,.76);--score-border:rgba(207,124,83,.58);--score-glow:rgba(207,114,75,.3);--score-title:#8f4d38;--score-gem:radial-gradient(circle at 34% 24%,#fff5e8,#e5a16f 36%,#a45b37 70%,#6d3729);}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option--silver{--score-card:rgba(226,240,255,.78);--score-border:rgba(149,188,222,.58);--score-glow:rgba(159,206,242,.32);--score-title:#526f9c;--score-gem:radial-gradient(circle at 34% 24%,#fff,#e9f8ff 36%,#a9cdf0 68%,#668eb9);}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option--gold{--score-card:rgba(255,239,205,.82);--score-border:rgba(223,173,74,.66);--score-glow:rgba(225,167,58,.36);--score-title:#95631f;--score-gem:radial-gradient(circle at 34% 24%,#fffdf0,#ffe08d 36%,#d39a32 70%,#90611f);}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option--top{--score-card:rgba(228,205,255,.78);--score-border:rgba(160,107,225,.62);--score-glow:rgba(166,102,232,.36);--score-title:#6e46a3;--score-gem:radial-gradient(circle at 34% 24%,#fff,#d7b7ff 35%,#8a5be6 66%,#4c63d9);}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option--none{--score-card:rgba(239,242,255,.78);--score-border:rgba(179,188,218,.58);--score-glow:rgba(177,193,231,.28);--score-title:#667096;--score-gem:radial-gradient(circle at 34% 24%,#fff,#eef4ff 38%,#c8d4ef 68%,#9eaac8);}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__voters{position:relative!important;display:grid!important;gap:10px!important;padding:13px!important;overflow:hidden!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__header{display:flex!important;align-items:center!important;justify-content:center!important;gap:9px!important;flex-wrap:wrap!important;text-align:center!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__eyebrow{padding:4px 10px!important;border:1px solid rgba(181,147,225,.34)!important;border-radius:999px!important;background:rgba(255,255,255,.52)!important;color:var(--pearl-muted)!important;font-size:11px!important;font-weight:850!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__title{color:var(--pearl-deep)!important;font-size:15px!important;font-weight:950!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__status{color:var(--pearl-muted)!important;font-size:12px!important;line-height:1.5!important;text-align:center!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__grid{display:grid!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;gap:8px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__group{min-width:0!important;padding:9px!important;border:1px solid rgba(255,255,255,.48)!important;border-radius:14px!important;background:rgba(255,255,255,.44)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.72)!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__group-title{display:flex!important;justify-content:space-between!important;gap:6px!important;align-items:center!important;color:var(--pearl-deep)!important;font-size:12px!important;font-weight:900!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__group-title em{font-style:normal!important;color:var(--pearl-muted)!important;font-size:11px!important;font-weight:760!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__names{display:flex!important;flex-wrap:wrap!important;gap:5px!important;margin-top:8px!important;min-height:22px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__name,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__empty{display:inline-flex!important;max-width:100%!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;padding:3px 7px!important;border-radius:999px!important;border:1px solid rgba(181,147,225,.2)!important;background:rgba(255,255,255,.46)!important;color:rgba(96,70,132,.82)!important;font-size:11px!important;line-height:1.25!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__actions{position:sticky!important;bottom:0!important;z-index:3!important;display:flex!important;flex-wrap:wrap!important;align-items:center!important;justify-content:center!important;gap:10px!important;width:100%!important;margin-top:2px!important;padding:12px!important;border:1px solid rgba(255,255,255,.62)!important;border-radius:20px!important;background:linear-gradient(180deg,rgba(255,255,255,.74),rgba(240,229,255,.62))!important;box-shadow:0 -12px 24px rgba(121,86,176,.12),inset 0 1px 0 rgba(255,255,255,.86)!important;-webkit-backdrop-filter:blur(12px) saturate(1.12)!important;backdrop-filter:blur(12px) saturate(1.12)!important;box-sizing:border-box!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-action{appearance:none!important;-webkit-appearance:none!important;font:inherit!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;min-width:134px!important;min-height:44px!important;padding:10px 16px!important;border-radius:999px!important;border:1px solid rgba(181,147,225,.42)!important;background:linear-gradient(180deg,rgba(255,255,255,.72),rgba(238,229,255,.58))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.86),0 8px 16px rgba(121,86,176,.12)!important;color:var(--pearl-deep)!important;font-size:14px!important;font-weight:900!important;white-space:nowrap!important;cursor:pointer!important;transition:transform .16s ease,border-color .16s ease,box-shadow .16s ease,background .16s ease!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-action:hover{transform:translateY(-1px)!important;border-color:rgba(255,255,255,.9)!important;box-shadow:0 0 20px rgba(184,150,230,.24),inset 0 1px 0 rgba(255,255,255,.92)!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-action:disabled{opacity:1!important;filter:none!important;color:rgba(103,78,136,.54)!important;cursor:default!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-action--primary{border-color:rgba(255,255,255,.88)!important;background:linear-gradient(135deg,#91d8ff,#c9adff 54%,#ffaee2)!important;box-shadow:0 0 24px rgba(205,172,255,.34),0 10px 20px rgba(122,86,178,.16),inset 0 1px 0 rgba(255,255,255,.8)!important;color:#583a86!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-action--danger{border-color:rgba(255,210,230,.76)!important;background:linear-gradient(135deg,#ffd1e6,#d2b2ff)!important;color:#743c82!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-action--soft:last-child{opacity:.9!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__footer-note{text-align:center!important;padding:10px 12px!important;border:1px solid rgba(255,255,255,.48)!important;border-radius:16px!important;background:linear-gradient(90deg,transparent,rgba(255,255,255,.42),transparent)!important;color:rgba(98,72,132,.74)!important;font-size:12px!important;line-height:1.5!important;}",
            "@media (max-width:920px){.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__options{grid-template-columns:repeat(3,minmax(118px,1fr))!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;}}",
            "@media (max-width:720px){.live2d-quiz.is-score-guess.live2d-popup--score-guess{width:min(92vw,520px)!important;max-width:calc(100vw - 24px)!important;max-height:calc(100vh - 88px)!important;padding:10px!important;overflow:hidden!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"]{width:100%!important;max-width:100%!important;max-height:calc(100vh - 108px)!important;padding:18px!important;gap:12px!important;border-radius:22px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__header{padding:0 24px 2px!important;text-align:left!important;align-items:flex-start!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__heading{align-items:flex-start!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__title-row{justify-content:flex-start!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__title{font-size:32px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__question{font-size:17px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__options,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-settlement,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__grid{grid-template-columns:1fr!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option{grid-template-columns:62px minmax(0,1fr) auto!important;grid-template-rows:auto!important;justify-items:start!important;align-items:center!important;min-height:92px!important;padding:13px!important;border-radius:20px!important;text-align:left!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__badge{width:62px!important;height:62px!important;margin:0!important;font-size:20px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__body{text-align:left!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__name{font-size:21px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__mark{position:static!important;transform:none!important;justify-self:end!important;align-self:start!important;min-width:64px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__actions{display:grid!important;grid-template-columns:1fr!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-action{width:100%!important;min-width:0!important;}}",
            ".live2d-quiz.is-score-guess.live2d-popup--score-guess[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"]{width:min(920px,calc(100vw - 40px))!important;max-width:calc(100vw - 40px)!important;max-height:calc(100vh - 40px)!important;overflow:hidden!important;padding:12px!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"]{max-width:880px!important;max-height:calc(100vh - 64px)!important;gap:10px!important;padding:20px 22px 16px!important;scroll-padding-bottom:86px!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__header{order:1!important;gap:5px!important;padding:0 44px 0!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__eyebrow{min-height:28px!important;padding:4px 18px!important;font-size:12px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__title{font-size:34px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__status-pill{padding:6px 12px!important;font-size:12px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__question{font-size:17px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__desc{font-size:12px!important;line-height:1.45!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta{order:2!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:9px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta-item{grid-template-columns:38px minmax(0,1fr)!important;min-height:58px!important;padding:9px 11px!important;border-radius:16px!important;gap:8px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta-icon{width:38px!important;height:38px!important;font-size:15px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta-label{font-size:11px!important;margin-bottom:2px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta-value{font-size:14px!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake{order:3!important;padding:10px 12px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-settlement{order:3!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;padding:9px!important;gap:8px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-settlement__item{padding:8px 9px!important;border-radius:13px!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__options{order:4!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:10px!important;padding:2px 0!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option--wide{grid-column:1/-1!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option{grid-template-columns:56px minmax(0,1fr) auto!important;grid-template-rows:auto!important;align-items:center!important;justify-items:start!important;min-height:74px!important;padding:10px 12px!important;border-radius:18px!important;text-align:left!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__badge{width:56px!important;height:56px!important;margin:0!important;font-size:18px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__body{text-align:left!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__name{font-size:20px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__count{font-size:12px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option__mark{position:static!important;align-self:start!important;justify-self:end!important;transform:none!important;min-width:64px!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__actions{order:5!important;position:sticky!important;bottom:0!important;z-index:8!important;margin-top:0!important;padding:9px 10px!important;gap:8px!important;background:linear-gradient(180deg,rgba(255,255,255,.9),rgba(240,229,255,.82))!important;box-shadow:0 -10px 24px rgba(121,86,176,.16),0 0 0 1px rgba(255,255,255,.34),inset 0 1px 0 rgba(255,255,255,.92)!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-action{min-height:40px!important;min-width:120px!important;padding:8px 14px!important;font-size:13px!important;}",
            ".score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__voters{order:6!important;max-height:170px!important;overflow-y:auto!important;overflow-x:hidden!important;padding:10px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__grid{grid-template-columns:repeat(5,minmax(0,1fr))!important;gap:7px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__footer-note{order:7!important;padding:8px 10px!important;font-size:12px!important;}",
            "@media (max-width:720px){.live2d-quiz.is-score-guess.live2d-popup--score-guess[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"]{width:min(92vw,520px)!important;max-width:calc(100vw - 24px)!important;max-height:calc(100vh - 88px)!important;padding:10px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"]{max-height:calc(100vh - 108px)!important;padding:16px!important;gap:10px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__header{padding:0 26px 0!important;text-align:left!important;align-items:flex-start!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__meta,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__options,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-stake,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-settlement,.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-voters__grid{grid-template-columns:1fr!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-option{grid-template-columns:56px minmax(0,1fr) auto!important;min-height:78px!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-panel__actions{display:grid!important;grid-template-columns:1fr!important;}.score-guess-panel.score-guess-panel--final[data-score-guess-ui-version=\"20260702-score-guess-admin-visible1\"] .score-guess-action{width:100%!important;min-width:0!important;}}",
    ...
    function initInteractions() {
        ...
        function renderScoreGuessResults(state, message, type) {
            ...
            dialog.setAttribute("data-score-guess-ui-version", "20260702-score-guess-admin-visible1");
            options.setAttribute("data-score-guess-ui-version", "20260702-score-guess-admin-visible1");
            options.innerHTML = [
                '<div class="score-guess-panel score-guess-panel--final" data-score-guess-ui-version="20260702-score-guess-admin-visible1">',
            ...
            console.info("[score-guess-ui]", {
                version: "20260702-score-guess-admin-visible1",
                hasPanel: !!document.querySelector('.score-guess-panel[data-score-guess-ui-version="20260702-score-guess-admin-visible1"]'),
